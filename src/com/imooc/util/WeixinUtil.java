...
public class WeixinUtil {
	...
	public static String translate(String source) throws ParseException, IOException{
		String url = "http://api.fanyi.baidu.com/api/trans/vip/translate?q=KEYWORD&from=en&to=zh&appid=APPID&salt=SALT&sign=SIGNATURE";
        ...
        url = url.replace("SALT", SALT).replace("APPID", APPID);
        ...
        try {
            ...
            if (engine instanceof Invocable) {
                ...
                System.out.println("APPID:"+APPID+",source:" +source +",SALT"+ SALT +",KEY:"+ KEY);
                SIGN = (String) invoke.invokeFunction("MD5",
                        APPID + source + SALT + KEY);
               url = url.replace("SIGNATURE", SIGN);
            }
